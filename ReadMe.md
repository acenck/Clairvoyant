Clairvoyant is a web app that will allow users to log into a personalized account holding a directory of their contacts. The app currently allows users to create, edit, and delete contacts. 
